 ...
 * @version July 2000
 */
public class PointCPD3 implements InterfacePointCP<PointCPD3, PointCPD2>
{
	//Instance variables ************************************************

	/**
	 * Contains C(artesian) identify the type of
	 ...
	 */
	public PointCPD3(double x, double y)
	{
		this.x = x;
		this.y = y;
		this.typeCoord = 'C';
