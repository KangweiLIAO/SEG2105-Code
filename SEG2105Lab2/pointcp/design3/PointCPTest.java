...
public class PointCPTest
{
	...
	public static void main(String[] args)
	{
		...
		PointCPD3 cPoint= new PointCPD3(coords[0], coords[1]); //initialize PointCPD3 instance
		...
		try
		{
			cPoint = new PointCPD3(Double.valueOf(args[0]).doubleValue(), 
		...
		catch(Exception e)
		{
			...
			try
			{
				...
				if(coordType == 'C') 
				{
					...
					cPoint = pPoint.convertStorageToCartesian();
				}
			}
	...
	private static void showTestResult(long[][] samples, int iterations, int sampleSize) {
		...
		System.out.println("\nTest runs on "+sampleSize + " PointCPD3 samples with "+iterations+" iterations for each methods:");
